...
<nav class="hidden navbar navbar-default navbar-fixed-top" id="triangleNav">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1000" height="200" id="svg1">
        ...
        <image xlink:href="assets/img/stock/stockIm4.png" clip-path="url(#clip5)" class="im1" id="landerImage1"></image>
        ...
        <image xlink:href="assets/img/stock/stockIm2.png" clip-path="url(#clip6)" class="im5" id="landerImage5"></image>
