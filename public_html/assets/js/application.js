...
function formSubmit(theForm) {
    ...
    Parse.User.logIn('user', 'pass').then(function () {
        ...
        console.log("success");
        console.log(theForm);
        document.getElementById("theForm").parentNode.innerHTML = "<div style='text-align: left; margin-top: 100px'><h4 id='thank'>Thank You for Submitting your Application</h4><p id='msg'>We will get back to you as soon as possible <span id='lol'>_</span></p></div>";
    }, function(err) {
        console.log("error");
        console.log(err);
    });
