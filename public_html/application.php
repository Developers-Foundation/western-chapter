...
<head>
    ...
    <meta name="description" content="Join Developers' Foundation Western Chapter Now">
...
<!--                <div class="row text-left">-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <textarea id="why" placeholder="what do you aim to achieve by working with df?"></textarea>
                    </div>
                </div>
